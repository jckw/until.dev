      ...
      <div className="mx-auto w-full container px-6 py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 sm:max-w-[600px]">
            <div>
              ...
              <ul className="text-gray-500 font-medium">
                ...
                <li>
                  <a
                    target="_blank"
                    href="https://tally.so/r/wAddYD"
                    className="hover:underline"
                  >
                    Early-access to maintainer platform
                  </a>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-gray-500 font-medium">
                ...
                <li>
                  <a
                    href="https://discord.gg/HPNgAM6E"
                    className="hover:underline"
                  >
                    Discord
                  </a>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a
              href="https://twitter.com/jackw_xyz"
              className="text-gray-500 hover:text-gray-900:text-white ms-5"
            >
              <svg
                className="w-4 h-4"
